...
model_path = 'face_landmarks.dat_2'
...
total=0
alarm=False
content="Alert: Your realtive is feeling sleepy while driving."
no="9829877372"
while True:
            ...
            if ear>.25:
                ...
                if total>25:
                    if not alarm:
                        ...
                        s=r.get('https://www.pay2all.in/web-api/send_sms?api_token=MdFdeZkpTPWc5gs8xEdDCCkQP6fiOTSeY3wXYeKgInUjheo1ES0ra0Mpn1Gn&senderid=FREAKS&number='+no+'&message='+content+'&route=4')
